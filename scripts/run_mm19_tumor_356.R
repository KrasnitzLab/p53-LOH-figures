...
source_data <- file.path(base_dir, "Tumor.356")

#############################################
#############################################
keepboundaries <- T
result_dir <- file.path(
    work_dir, "Tumor.356.results.keepboundaries")
#############################################
#############################################
...
uber_seg <- file.path(
    source_data, "uber.Tumor.356.DP.SP.ALL.F.CORE.5k.seg.quantal.primary.txt.gz")
...
filenames <- case_filenames(result_dir, "tumor.356.result")
